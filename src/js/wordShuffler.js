function WordShuffler(holder, opt) {
  ...
  var options = {
    ...
    needUpdate: true,
    colors: [
      //シャッフル中のテキストカラー。複数指定すると１文字ずつ色が変わる
      // '#333',
      // '#f44336',
      // '#e91e63','#9c27b0',
...
// var wsElm1 = document.getElementById('js-wsElm1');
// var wsElm2 = document.getElementById('js-wsElm2');
// var wsElm3 = document.getElementById('js-wsElm3');

// var wordShuffle1 = new WordShuffler(wsElm1, {
//   textColor: '#0000c8',
// });
...
if (document.querySelector('.js-wordShuffler') !== null) {
  // ターゲット（複数）
  const targets = document.querySelectorAll('.js-wordShuffler');
  ...
  function doWhenTargetObserve(entries, observerStop) {
    ...
    entries.forEach((entry) => {
      ...
      //   textColor: '#0000c8',
      // });
      // var wordShuffle2 = new WordShuffler(wsElm2, {
      //   textColor: '#0000c8',
      // });
      // var wordShuffle3 = new WordShuffler(wsElm3, {
      //   textColor: '#0000c8',
      // });
